class SeedRolesPrivilegios < ActiveRecord::Migration[5.1]
  def up
    ...
    execute "INSERT INTO roles_privilegios (role_id, privilegio_id, alcance, created_at, updated_at) VALUES (6,14, 1, NOW(), NOW())"
    execute "INSERT INTO roles_privilegios (role_id, privilegio_id, alcance, created_at, updated_at) VALUES (6,9,1, NOW(), NOW())"
    ...
    execute "INSERT INTO roles_privilegios (role_id, privilegio_id, alcance, created_at, updated_at) VALUES (7,2,1,NOW(), NOW())"
    execute "INSERT INTO roles_privilegios (role_id, privilegio_id, alcance, created_at, updated_at) VALUES (7,11,1, NOW(), NOW())"
  end
end
