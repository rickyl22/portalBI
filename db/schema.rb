...
ActiveRecord::Schema.define(version: 20170803150728) do
  ...
  create_table "activaciones", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.date "fecha"
    t.integer "cantidad"
    t.string "plataforma"
  ...
  create_table "alta", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.date "fecha"
    t.integer "cantidad"
    t.string "plataforma"
    t.datetime "created_at", null: false
  ...
  create_table "altas_plans", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.date "fecha"
    t.string "plan"
    t.integer "cantidad"
    t.string "plataforma"
  ...
  create_table "pronostico_alta", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.date "fecha"
    t.integer "cantidad"
    t.string "plataforma"
    t.datetime "created_at", null: false
  ...
  create_table "pronostico_recargas", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.date "fecha"
    t.integer "cantidad"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "recargas", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.date "FECHA"
    t.integer "CLIENTES"
    t.integer "RECARGAS"
  ...
  create_table "recargas_terminals", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.string "TERMINAL"
    t.date "FECHA"
    t.integer "CLIENTES"
    t.integer "RECARGAS"
