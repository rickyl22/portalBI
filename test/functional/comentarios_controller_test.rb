...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { comment: @comentario.comment, enviado: @comentario.enviado, usuario: @comentario.usuario }
    end
  ...
  test "should update comentario" do
    put :update, id: @comentario, comentario: { comment: @comentario.comment, enviado: @comentario.enviado, usuario: @comentario.usuario }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
